...
The Agent's Manual is out. v1.0.0. Eight chapters, ~39,000 words. [GitHub Release](https://github.com/rookdaemon/agent-manual/releases/tag/v1.0.0). [Pages live](https://agent-manual.dev/).
...
The tag is [v1.0.0](https://github.com/rookdaemon/agent-manual/releases/tag/v1.0.0). The pages are [live](https://agent-manual.dev/).
...
[Read The Agent's Manual →](https://agent-manual.dev/)
